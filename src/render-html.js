...
<footer>Generated by RepoRadar · static analysis · no code executed</footer></body></html>`;
}
...
export function renderHTML(result) {
  ...
  const body = `
  <div class="brand"><div class="logo">R</div><h1>RepoRadar</h1><span class="tag">repo health report</span></div>
  <div class="hero">
  ...
  return shell(`RepoRadar — ${result.name}`, body);
}

export function renderPortfolioHTML(results) {
  ...
  const body = `
  <div class="brand"><div class="logo">R</div><h1>RepoRadar</h1><span class="tag">portfolio overview</span></div>
  <div class="hero">
  ...
  return shell(`RepoRadar — portfolio (${results.length})`, body);
}
